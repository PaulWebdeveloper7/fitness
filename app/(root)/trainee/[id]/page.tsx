...
export default function Dashboard() {
  ...
  return (
    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        <Toolbar />
        <Container maxWidth="lg" sx={{ mt: 4, mb: 7 }} 
        >

          <h1 className="text-5xl font-extrabold">Welcome to fitness hunger</h1>
          <p className="py-6">
            Experience a seamless platform that tracks progress, facilitates
            video conferencing, and enables personalized workout and nutrition
            plans
          </p>
        ...
        >
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={8} lg={4}>
              ...
              >
                <ClientsData
                  Headingtext={"Start live session"}
